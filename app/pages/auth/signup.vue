        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          <div class="flex flex-col gap-3">
            ...
            <input
              ...
              class="text-slate-200 w-full rounded-lg bg-transparent px-4 py-3 ring-2 ring-dark-600 placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:ring-offset-0 disabled:opacity-60"
          ...
          <div class="mt-6 flex items-center gap-2">
            <input id="same" v-model="r$.$value.sameAsPhone" type="checkbox" class="h-4 w-4" />
